...
![mineable trial spawner datapack/mod title image minecraft](https://cdn.jsdelivr.net/gh/jodeks-datapacks/Assets@main/titles/mineable_trial_spawner.png)
...
[![mineable trial spawner minecraft datapack github issues](https://cdn.jsdelivr.net/gh/jodeks-datapacks/Assets@main/badges/GH_Issues.png)](https://github.com/jodeks-datapacks/mineable-trial-spawner/issues)&nbsp;&nbsp;
...
**1.** Mined trial spawners & vaults drop when mined with a pickaxe (default: enabled)

**2.** Setting so they only drop with a silktouch pickaxe (default: disabled)


## Config

```
/trigger mineable_trial_spawner.config
```
